...
import lesson14.entity.Information;
import lesson14.entity.InitializationData;
...
//    initializationData.fillData(); // test
        ...
        for (int i = 0; i < 10; i++)
            numbersInteger.add((int) (Math.round(1000000000 * Math.random()))); // 10 random numbers as nicks
